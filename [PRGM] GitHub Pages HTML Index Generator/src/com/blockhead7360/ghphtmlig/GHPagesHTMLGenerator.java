...
public class GHPagesHTMLGenerator {
	...
	public GHPagesHTMLGenerator() {
		...
		Runnable go = new Runnable() {
			public void run() {
				int op = JOptionPane.showOptionDialog(null, "Welcome to the GitHub Pages HTML Index Guide Generator!\nVersion " + version + " by Dilan (http://blockhead7360.com)\nSelect an option below to begin.", "GHPHTMLIGG by Blockhead7360", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new Object[] {"Create Index Guide", "Close"}, "Create Index Guide");
